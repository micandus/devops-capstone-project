...
![Build Status](https://github.com/micandus/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
This project is the end project for the IBM Coursera course. It shall implement a RESTfull API for an account managment database.
