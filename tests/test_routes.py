...
class TestAccountService(TestCase):
    ...
    def test_update_account(self):
        ...
        update_account["name"] = "This is a test"
        response = self.client.put(f"{BASE_URL}/{update_account['id']}", json=update_account)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_delete_invalid_account(self):
        """It should return 404 for a bad delete request"""
        response = self.client.delete(f"{BASE_URL}/0")
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)

    def test_security_headers(self):
        """It should use Flask-Talisman for security headers"""
